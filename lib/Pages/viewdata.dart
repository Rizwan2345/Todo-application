...
class ViewData extends StatefulWidget {
  const ViewData({Key? key,required this.id, required this.document}) : super(key: key);
...
class _ViewDataState extends State<ViewData> {
  ...
  void initState(){
    ...
    _descriptioncontroller=TextEditingController(text: widget.document["description"].toString());
